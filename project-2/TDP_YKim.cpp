...
class TDP {										// Data structure for the Table Driven Parser
	private:
		string tdp_table[TDP_NROW][TDP_NCOL] = {									//	id	+	-	*	/	(	)	;	=	UNDECIDED
				{"TQ"	, "NULL", "NULL", "NULL", "NULL", "TQ"	, "NULL", "NULL", "NULL", "skip"},		// E |  TQ					TQ				skip
				{"NULL"	, "+TQ"	, "-TQ"	, "NULL", "NULL", "NULL", "e"	, "e"	, "NULL", "skip"},		// Q |		+TQ	-TQ				e	e		skip
				{"FR"	, "NULL", "NULL", "NULL", "NULL", "FR"	, "NULL", "NULL", "NULL", "skip"},		// T |	FR					FR				skip
				{"NULL"	, "e"	, "e"	, "*FR"	, "/FR"	, "NULL", "e"	, "e"	, "NULL", "skip"},		// R |		e	e	*FR	/FR		e	e		skip
				{"i"	, "NULL", "NULL", "NULL", "NULL", "(E)"	, "NULL", "NULL", "NULL", "skip"},		// F |	i					(E)				skip
				{"i=E"	, "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "NULL", "skip"}		// S |	i=E									skip
		};
	public:
